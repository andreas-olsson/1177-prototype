        ...
        <IDSContainer className="ids-content">
          <IDSRow justify="start" gap="2rem">
            <IDSCol cols="12" m="12" s="12">
              <h1 className="ids-heading-1 ids-mt-4">
                Hej! <br />
          ...
          <IDSRow justify="space-around" gap="1rem" className="ids-mt-12">
            <IDSCol m="5" s="12">
              <IDSList>
                <IDSListItem
                  interactive={true}
                  headline="Söka vård under resan"
                >
                  ...
                  />
                  Här finns information om vilka mottagningar du kan kontakta om
                  du eller någon i din familj behöver söka vård under resan.
                  Välj den region du befinner dig i överst på sidan.
                </IDSListItem>
              </IDSList>
            </IDSCol>
            <IDSCol m="5" s="12">
              <IDSList>
                <IDSListItem interactive={true} headline="Magsjuketider">
                  ...
                  />
                  Det är många som söker information om magsjuka just nu. Trots
                  att du kan må mycket dåligt brukar magsjuka sällan vara
                  allvarligt. Oftast räcker det med att vila och dricka mycket.
                </IDSListItem>
              </IDSList>
            </IDSCol>
            <IDSCol m="5" s="12">
              <IDSList>
                <IDSListItem
                  interactive={true}
                  headline="Vilka vaccin bör man ta?"
                >
                  <a href="#" slot="interactive"></a>
                  <img
                    className="ids-img ids-mb-2"
                  ...
                  />
                  Vilka vaccinationer som du rekommenderas att ta beror på din
                  ålder och hälsotillstånd. Vissa vaccin är kostnadsfria, andra
                  kostar. Här beskriver vi vilka olika vaccin som rekommenderas
          ...
          <IDSRow justify="space-around" gap="2rem" className="ids-mt-12">
            ...
            <IDSCol m="5" s="12">
              <IDSList>
                <IDSListItem
                  interactive={true}
                  headline="Borsta tänder på barn"
                >
                  <a href="#" slot="interactive"></a>
                  <img
                    className="ids-img ids-mb-2"
            ...
            <IDSCol m="5" s="12">
              <IDSList>
                <IDSListItem interactive={true} headline="Är du förkyld?">
                  ...
                  />
                  En förkylning brukar gå över av sig själv, men det finns saker
                  du kan göra för att lindra symtomen.
                </IDSListItem>
              </IDSList>
            </IDSCol>
          </IDSRow>
